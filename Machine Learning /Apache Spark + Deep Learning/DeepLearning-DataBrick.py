...
# MAGIC %md
# MAGIC # CS570- Big Data Analytics and Processing
# MAGIC # Name: Feven Belay Araya
# MAGIC # Id: 20027
...
# MAGIC * This notebook works with spark-deep-learning release `0.1.0-spark2.1-s_2.11`. Future releases may introduce breaking changes. Please refer to the project's [github page](https://github.com/databricks/spark-deep-learning) for the latest examples and docs.
# MAGIC * To run this notebook, also create and attach the following libraries via PyPI: tensorflow, keras, h5py.
# MAGIC
